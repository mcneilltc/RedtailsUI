        ...
        <Box sx={{ py: 8, backgroundColor: "background.default", px: 2 }}>
          <Container>
            ...
            <Typography variant="body1" sx={{ color: "text.secondary", mb: 3 }}>
              ...
              Carolina, we offer kayak and paddleboard rentals, self-guided tours,
              and special events designed for families, tourists, and outdoor
            ...
            <Typography variant="body1" sx={{ color: "text.secondary", mb: 3 }}>
              ...
              in creating experiences that let you enjoy the natural beauty around
              us while respecting it for future generations.
            </Typography>
            ...
            <Grid container spacing={4} justifyContent="center">
              ...
              <Grid size={{ xs: 12, sm:6, md: 4 }} textAlign="center">
                ...
                <Typography variant="body2" color="text.secondary" mt={1}>
                  ...
                  about connecting people with nature. An Eagle Scout with over 10
                  years of experience, he’s a true adventurer at heart!
                </Typography>
              </Grid>
